...
public class XScope {
	...
	public static final String[] X_SCALE = {"200ms/div","100ms/div","50ms/div","25ms/div", "20ms/div","10ms/div","5ms/div", "3ms/div","2ms/div","1ms/div"};
	...
	int pointCounter = 0;
	ObservableList<DataNode> dataPoints;
	boolean cc1En = true;
	boolean cc2En = true;
	boolean vbusEn = true;
	boolean ampEn = true;
	...
	private void chartInit(){
        ...
        lchartData.getData().addAll(seriesVbus, seriesAmp, seriesCC1, seriesCC2, seriesHMarker,seriesVMarker);
	...
	private void panelInit(){
		...
		cboxGraphXScale.getSelectionModel().select(1);
	...
	private void mouseClicked(MouseEvent e) {
		...
		lblGraphDeltaY.setText(formatter.format(yDiff) + "u");
	...
	private void mouseMoved(MouseEvent e) {
		...
		if(xValue != null && yValue != null){
			...
			lblGraphYValue.setText(formatter.format(yValue) + "u");
			}
	}

	public void setDataPoints(ObservableList<DataNode> dataPoints){
